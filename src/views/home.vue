    ...
    data() {
      return {
        ...
        carousel_content: [
          ...
          "不得不说，很多道听途说的图谱信息其实并不准确，眼睛看到的也不一定为实，那么到底如何才能主动掌握精准信息呢？\n其实不需要多复杂，你也不用请私家侦探，使用OwO就能让你拥有火眼金睛，有了它一定能给你带来很大的帮助！",
          "说句掏心窝子的话，在这个互联网信息杂乱的时代，我们很有必要拥有主动掌握准确信息的能力，否则一个错误的知识可能会让人们陷入困境，也许在你做决定之前使用一下这个平台就能避免很多事情的发生！",
          "OWO COIN的产品非常好用！是一款全新的，前所未有的智能图谱平台，帮助我解决了信息处理的问题！非常赞！",
          "不得不说，很多道听途说的图谱信息其实并不准确，眼睛看到的也不一定为实，那么到底如何才能主动掌握精准信息呢？\n其实不需要多复杂，你也不用请私家侦探，使用OwO就能让你拥有火眼金睛，有了它一定能给你带来很大的帮助！",
          "说句掏心窝子的话，在这个互联网信息杂乱的时代，我们很有必要拥有主动掌握准确信息的能力，否则一个错误的知识可能会让人们陷入困境，也许在你做决定之前使用一下这个平台就能避免很多事情的发生！",
        ]
      };
